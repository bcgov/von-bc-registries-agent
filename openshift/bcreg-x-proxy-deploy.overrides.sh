# ========================================================================
# Special Deployment Parameters needed for the bcreg-x-proxy instance.
# ------------------------------------------------------------------------
...
CONFIG_MAP_NAME=bcreg-x-proxy-caddy-conf
SOURCE_FILE=../bcreg-x/caddy/Caddyfile
OUTPUT_FORMAT=json
OUTPUT_FILE=bcreg-x-proxy-caddy-configmap_DeploymentConfig.json
