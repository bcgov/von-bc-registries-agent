...
try:
    with EventProcessor() as event_processor:
        ...
        if not corp_types or 0 == len(corp_types):
            event_processor.process_corp_event_queue_and_generate_creds(lear_system_type, use_cache=False, corp_types=LEAR_CORP_TYPES_IN_SCOPE)
        else:
            ...
            event_processor.process_corp_event_queue_and_generate_creds(lear_system_type, use_cache=False, corp_types=corp_types_scope)                    
